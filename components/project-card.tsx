...
export function ProjectCard({
  ...
  return (
    <Link href={`/projeler/${project.id}`} className="group">
      <article className="relative aspect-[3/4] overflow-hidden rounded-2xl border border-border bg-card transition-all duration-300 hover:border-primary/30 hover:shadow-xl hover:shadow-primary/5">
        <img
